...
import com.msi.sardorbek_asilov.databinding.ActivityBook5Binding;
import com.msi.sardorbek_asilov.databinding.ActivityBook6Binding;

public class Book6Activity extends AppCompatActivity {

    private ActivityBook6Binding binding;
    private static final String PREFS_NAME = "FAVORITES";
    private static final String BOOK6_KEY = "BOOK6_FAVORITE";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        binding = ActivityBook6Binding.inflate(getLayoutInflater());
    ...
    public void backBtn(View v) {
        Intent intent = new Intent(Book6Activity.this, DashboardUserActivity.class);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Да", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        // Переход на сайт
                        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://flibusta.su/book/353704-zvezdnaa-krov---8-psy-vecnosti/d/read/"));
    ...
    public void downloadBtn(View v) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Да", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        // Переход на сайт
                        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://flibusta.su/book/353704-zvezdnaa-krov---8-psy-vecnosti/d/?f=a4.pdf"));
                        startActivity(browserIntent);
                    }
                })
                .setNegativeButton("Нет", null)
    ...
    public void favoriteBtn(View v) {
        ...
        boolean isFavorite = sharedPreferences.getBoolean(BOOK6_KEY, false);
        SharedPreferences.Editor editor = sharedPreferences.edit();

        if (isFavorite) {
            editor.remove(BOOK6_KEY);
            Toast.makeText(this, "Удалено из избранного!", Toast.LENGTH_SHORT).show();
        } else {
            editor.putBoolean(BOOK6_KEY, true);
