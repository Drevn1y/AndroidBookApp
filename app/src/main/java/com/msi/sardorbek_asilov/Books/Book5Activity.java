...
public class Book5Activity extends AppCompatActivity {
    ...
    private ActivityBook5Binding binding;
    private static final String PREFS_NAME = "FAVORITES";
    private static final String BOOK5_KEY = "BOOK5_FAVORITE";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        binding = ActivityBook5Binding.inflate(getLayoutInflater());
    ...
    public void backBtn(View v) {
        Intent intent = new Intent(Book5Activity.this, DashboardUserActivity.class);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Да", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        // Переход на сайт
                        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://flibusta.su/book/353700-led-kuznec/d/read/"));
    ...
    public void downloadBtn(View v) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Да", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        // Переход на сайт
                        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://flibusta.su/book/353700-led-kuznec/d/?f=a4.pdf"));
                        startActivity(browserIntent);
                    }
                })
                .setNegativeButton("Нет", null)
    ...
    public void favoriteBtn(View v) {
        ...
        boolean isFavorite = sharedPreferences.getBoolean(BOOK5_KEY, false);
        SharedPreferences.Editor editor = sharedPreferences.edit();

        if (isFavorite) {
            editor.remove(BOOK5_KEY);
            Toast.makeText(this, "Удалено из избранного!", Toast.LENGTH_SHORT).show();
        } else {
            editor.putBoolean(BOOK5_KEY, true);
