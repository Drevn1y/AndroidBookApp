...
import com.msi.sardorbek_asilov.databinding.ActivityBook15Binding;
...
public class Book15Activity extends AppCompatActivity {

    private ActivityBook15Binding binding;
    private static final String PREFS_NAME = "FAVORITES";
    private static final String BOOK15_KEY = "BOOK15_FAVORITE";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        binding = ActivityBook15Binding.inflate(getLayoutInflater());
    ...
    public void backBtn(View v) {
        Intent intent = new Intent(Book15Activity.this, DashboardUserActivity.class);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Да", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        // Переход на сайт
                        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://flibusta.su/book/19562-doroga-v-kitezh/read/"));
    ...
    public void downloadBtn(View v) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Да", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        // Переход на сайт
                        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://flibusta.su/book/19562-doroga-v-kitezh/d/?f=a4.pdf"));
                        startActivity(browserIntent);
                    }
                })
                .setNegativeButton("Нет", null)
    ...
    public void favoriteBtn(View v) {
        ...
        boolean isFavorite = sharedPreferences.getBoolean(BOOK15_KEY, false);
        SharedPreferences.Editor editor = sharedPreferences.edit();

        if (isFavorite) {
            editor.remove(BOOK15_KEY);
            Toast.makeText(this, "Удалено из избранного!", Toast.LENGTH_SHORT).show();
        } else {
            editor.putBoolean(BOOK15_KEY, true);
