...
import com.msi.sardorbek_asilov.databinding.ActivityBook14Binding;
...
public class Book14Activity extends AppCompatActivity {

    private ActivityBook14Binding binding;
    private static final String PREFS_NAME = "FAVORITES";
    private static final String BOOK14_KEY = "BOOK14_FAVORITE";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        binding = ActivityBook14Binding.inflate(getLayoutInflater());
    ...
    public void backBtn(View v) {
        Intent intent = new Intent(Book14Activity.this, DashboardUserActivity.class);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Да", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        // Переход на сайт
                        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://flibusta.su/book/1000-trevozhnyie-lyudi/read/"));
    ...
    public void downloadBtn(View v) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Да", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        // Переход на сайт
                        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://flibusta.su/book/1000-trevozhnyie-lyudi/d/?f=a4.pdf"));
                        startActivity(browserIntent);
                    }
                })
                .setNegativeButton("Нет", null)
    ...
    public void favoriteBtn(View v) {
        ...
        boolean isFavorite = sharedPreferences.getBoolean(BOOK14_KEY, false);
        SharedPreferences.Editor editor = sharedPreferences.edit();

        if (isFavorite) {
            editor.remove(BOOK14_KEY);
            Toast.makeText(this, "Удалено из избранного!", Toast.LENGTH_SHORT).show();
        } else {
            editor.putBoolean(BOOK14_KEY, true);
