...
import com.msi.sardorbek_asilov.databinding.ActivityBook4Binding;

public class Book4Activity extends AppCompatActivity {

    private ActivityBook4Binding binding;
    private static final String PREFS_NAME = "FAVORITES";
    private static final String BOOK4_KEY = "BOOK4_FAVORITE";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        binding = ActivityBook4Binding.inflate(getLayoutInflater());
    ...
    public void backBtn(View v) {
        Intent intent = new Intent(Book4Activity.this, DashboardUserActivity.class);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Да", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        // Переход на сайт
                        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://flibusta.su/book/209902-silnee-vetra/read/"));
    ...
    public void downloadBtn(View v) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Да", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        // Переход на сайт
                        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://flibusta.su/book/209902-silnee-vetra/?f=a4.pdf"));
                        startActivity(browserIntent);
                    }
                })
                .setNegativeButton("Нет", null)
    ...
    public void favoriteBtn(View v) {
        ...
        boolean isFavorite = sharedPreferences.getBoolean(BOOK4_KEY, false);
        SharedPreferences.Editor editor = sharedPreferences.edit();

        if (isFavorite) {
            editor.remove(BOOK4_KEY);
            Toast.makeText(this, "Удалено из избранного!", Toast.LENGTH_SHORT).show();
        } else {
            editor.putBoolean(BOOK4_KEY, true);
