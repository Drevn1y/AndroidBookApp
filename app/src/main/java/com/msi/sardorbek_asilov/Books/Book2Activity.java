...
import com.msi.sardorbek_asilov.databinding.ActivityBook1Binding;
import com.msi.sardorbek_asilov.databinding.ActivityBook2Binding;
...
public class Book2Activity extends AppCompatActivity {
    ...
    private ActivityBook2Binding binding;
    private static final String PREFS_NAME = "FAVORITES";
    private static final String BOOK2_KEY = "BOOK2_FAVORITE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityBook2Binding.inflate(getLayoutInflater());
    ...
    checkFavoriteStatus();
        ...
        public void backBtn(View v) {
            Intent intent = new Intent(Book2Activity.this, DashboardUserActivity.class);
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Да", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            // Переход на сайт
                            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://flibusta.su/book/349324-tajna-mertvogo-rektora-kniga-1/read/"));
        ...
        public void downloadBtn(View v) {
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Да", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            // Переход на сайт
                            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://flibusta.su/book/349324-tajna-mertvogo-rektora-kniga-1/d/?f=a4.pdf"));
                            startActivity(browserIntent);
                        }
                    })
                    .setNegativeButton("Нет", null)
        ...
        public void favoriteBtn(View v) {
            ...
            boolean isFavorite = sharedPreferences.getBoolean(BOOK2_KEY, false);
            SharedPreferences.Editor editor = sharedPreferences.edit();

            if (isFavorite) {
                editor.remove(BOOK2_KEY);
                Toast.makeText(this, "Удалено из избранного!", Toast.LENGTH_SHORT).show();
            } else {
                editor.putBoolean(BOOK2_KEY, true);
